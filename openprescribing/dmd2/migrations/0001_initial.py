...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AMP',
            fields=[
                ('id', models.BigIntegerField(db_column=b'apid', help_text=b'Identifier', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='AMPP',
            fields=[
                ('id', models.BigIntegerField(db_column=b'appid', help_text=b'Identifier', primary_key=True, serialize=False)),
                ('invalid', models.BooleanField(help_text=b'Invalid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amp', models.OneToOneField(db_column=b'apid', help_text=b'AMP', on_delete=django.db.models.deletion.CASCADE, to='dmd2.AMP')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat', models.ForeignKey(db_column=b'catcd', help_text=b'Controlled Drug category', on_delete=django.db.models.deletion.CASCADE, to='dmd2.ControlDrugCategory')),
                ('cat_prev', models.ForeignKey(db_column=b'cat_prevcd', help_text=b'Previous Controlled Drug information', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='dmd2.ControlDrugCategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ampp', models.OneToOneField(db_column=b'appid', help_text=b'AMPP', on_delete=django.db.models.deletion.CASCADE, to='dmd2.AMPP')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Ing',
            fields=[
                ('id', models.BigIntegerField(db_column=b'isid', help_text=b'Identifier', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ampp', models.OneToOneField(db_column=b'appid', help_text=b'AMPP', on_delete=django.db.models.deletion.CASCADE, to='dmd2.AMPP')),
                ('price_basis', models.ForeignKey(db_column=b'price_basiscd', help_text=b'Price basis', on_delete=django.db.models.deletion.CASCADE, to='dmd2.PriceBasis')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='VMP',
            fields=[
                ('id', models.BigIntegerField(db_column=b'vpid', help_text=b'Identifier', primary_key=True, serialize=False)),
                ...
                ('pres_stat', models.ForeignKey(db_column=b'pres_statcd', help_text=b'Prescribing status', on_delete=django.db.models.deletion.CASCADE, to='dmd2.VirtualProductPresStatus')),
        ...
        migrations.CreateModel(
            name='VMPP',
            fields=[
                ('id', models.BigIntegerField(db_column=b'vppid', help_text=b'Identifier', primary_key=True, serialize=False)),
                ('invalid', models.BooleanField(help_text=b'Invalid')),
                ...
                ('vmp', models.ForeignKey(db_column=b'vpid', help_text=b'VMP', on_delete=django.db.models.deletion.CASCADE, to='dmd2.VMP')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ing', models.ForeignKey(db_column=b'isid', help_text=b'Ingredient', on_delete=django.db.models.deletion.CASCADE, to='dmd2.Ing')),
        ...
        migrations.CreateModel(
            name='VTM',
            fields=[
                ('id', models.BigIntegerField(db_column=b'vtmid', help_text=b'Identifier', primary_key=True, serialize=False)),
                ('invalid', models.BooleanField(help_text=b'Invalid')),
                ('nm', models.CharField(help_text=b'Name', max_length=255)),
                ('abbrevnm', models.CharField(help_text=b'Abbreviated name', max_length=60, null=True)),
        ...
        migrations.AddField(
            model_name='vmp',
            name='vtm',
            field=models.ForeignKey(db_column=b'vtmid', help_text=b'VTM', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.VTM'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='ont',
            name='form',
            field=models.ForeignKey(db_column=b'formcd', help_text=b'Form & Route', on_delete=django.db.models.deletion.CASCADE, to='dmd2.OntFormRoute'),
        ),
        migrations.AddField(
            model_name='ont',
            name='vmp',
            field=models.ForeignKey(db_column=b'vpid', help_text=b'VMP', on_delete=django.db.models.deletion.CASCADE, to='dmd2.VMP'),
        ),
        migrations.AddField(
            model_name='licroute',
            name='route',
        ...
        migrations.AddField(
            model_name='dtinfo',
            name='vmpp',
            field=models.OneToOneField(db_column=b'vppid', help_text=b'VMPP', on_delete=django.db.models.deletion.CASCADE, to='dmd2.VMPP'),
        ),
        migrations.AddField(
            model_name='droute',
            name='route',
        ...
        migrations.AddField(
            model_name='dform',
            name='vmp',
            field=models.OneToOneField(db_column=b'vpid', help_text=b'VMP', on_delete=django.db.models.deletion.CASCADE, to='dmd2.VMP'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='aping',
            name='ing',
            field=models.ForeignKey(db_column=b'isid', help_text=b'Ingredient', on_delete=django.db.models.deletion.CASCADE, to='dmd2.Ing'),
        ),
        migrations.AddField(
            model_name='aping',
            name='uom',
        ...
        migrations.AddField(
            model_name='ampp',
            name='disc',
            field=models.ForeignKey(db_column=b'disccd', help_text=b'Discontinued', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.DiscontinuedInd'),
        ),
        migrations.AddField(
            model_name='ampp',
            name='legal_cat',
        ...
        migrations.AddField(
            model_name='ampp',
            name='vmpp',
            field=models.ForeignKey(db_column=b'vppid', help_text=b'VMPP', on_delete=django.db.models.deletion.CASCADE, to='dmd2.VMPP'),
        ),
        migrations.AddField(
            model_name='amp',
            name='avail_restrict',
