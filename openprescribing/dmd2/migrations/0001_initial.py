    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ampp', models.OneToOneField(db_column=b'appid', help_text=b'AMPP identifier', on_delete=django.db.models.deletion.CASCADE, to='dmd2.AMPP')),
                ('dnd', models.ForeignKey(db_column=b'dndcd', help_text=b'Discount Not Deducted Indicator', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.Dnd')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('combprod', models.ForeignKey(db_column=b'combprodcd', help_text=b'Combination product Indicator', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.CombinationProdInd')),
                ('df_ind', models.ForeignKey(db_column=b'df_indcd', help_text=b'Dose form indicator', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.DfIndicator')),
                ...
                ('non_avail', models.ForeignKey(db_column=b'non_availcd', help_text=b'Non-availability indicator', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.VirtualProductNonAvail')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('combpack', models.ForeignKey(db_column=b'combpackcd', help_text=b'Combination pack indicator', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.CombinationPackInd')),
                ('qty_uom', models.ForeignKey(db_column=b'qty_uomcd', help_text=b'Quantity Unit of Measure code', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='dmd2.UnitOfMeasure')),
        ...
        migrations.AddField(
            ...
            name='spec_cont',
            field=models.ForeignKey(db_column=b'spec_contcd', help_text=b'Special Container Indicator code', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.SpecCont'),
        ),
        migrations.AddField(
            model_name='packinfo',
            name='reimb_stat',
            field=models.ForeignKey(db_column=b'reimb_statcd', help_text=b'Appliance Reimbursement status code', on_delete=django.db.models.deletion.CASCADE, to='dmd2.ReimbursementStatus'),
        ),
        migrations.AddField(
            model_name='packinfo',
            name='reimb_statprev',
            field=models.ForeignKey(db_column=b'reimb_statprevcd', help_text=b'Appliance Reimbursement previous status code', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='dmd2.ReimbursementStatus'),
        ),
        migrations.AddField(
            model_name='ont',
            name='form',
        ...
        migrations.AddField(
            model_name='dtinfo',
            name='pay_cat',
            field=models.ForeignKey(db_column=b'pay_catcd', help_text=b'Drug Tariff payment category code', on_delete=django.db.models.deletion.CASCADE, to='dmd2.DtPaymentCategory'),
        ),
        migrations.AddField(
            model_name='dtinfo',
            name='vmpp',
        ...
        migrations.AddField(
            model_name='droute',
            name='route',
            field=models.ForeignKey(db_column=b'routecd', help_text=b'Route code', on_delete=django.db.models.deletion.CASCADE, to='dmd2.Route'),
        ),
        migrations.AddField(
            model_name='droute',
            name='vmp',
        ...
        migrations.AddField(
            model_name='dform',
            name='form',
            field=models.ForeignKey(db_column=b'formcd', help_text=b'Formulation code', on_delete=django.db.models.deletion.CASCADE, to='dmd2.Form'),
        ),
        migrations.AddField(
            model_name='dform',
            name='vmp',
        ...
        migrations.AddField(
            model_name='aping',
            name='uom',
            field=models.ForeignKey(db_column=b'uomcd', help_text=b'Pharmaceutical Strength Unit of Measure code', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='dmd2.UnitOfMeasure'),
        ),
        migrations.AddField(
            model_name='apinfo',
            name='colour',
            field=models.ForeignKey(db_column=b'colourcd', help_text=b'Colour code', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.Colour'),
        ),
        migrations.AddField(
            model_name='ampp',
            name='combpack',
            field=models.ForeignKey(db_column=b'combpackcd', help_text=b'Combination pack Indicator code', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.CombinationPackInd'),
        ),
        migrations.AddField(
            model_name='ampp',
            name='disc',
            field=models.ForeignKey(db_column=b'disccd', help_text=b'Discontinued Flag code', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.DiscontinuedInd'),
        ),
        migrations.AddField(
            model_name='ampp',
            name='legal_cat',
            field=models.ForeignKey(db_column=b'legal_catcd', help_text=b'Legal category code', on_delete=django.db.models.deletion.CASCADE, to='dmd2.LegalCategory'),
        ),
        migrations.AddField(
            model_name='ampp',
            name='vmpp',
        ...
        migrations.AddField(
            model_name='amp',
            name='avail_restrict',
            field=models.ForeignKey(db_column=b'avail_restrictcd', help_text=b'Restrictions on availability Code', on_delete=django.db.models.deletion.CASCADE, to='dmd2.AvailabilityRestriction'),
        ),
        migrations.AddField(
            model_name='amp',
            name='combprod',
            field=models.ForeignKey(db_column=b'combprodcd', help_text=b'Combination product indicator Code', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.CombinationProdInd'),
        ),
        migrations.AddField(
            model_name='amp',
            name='flavour',
            field=models.ForeignKey(db_column=b'flavourcd', help_text=b'Flavour Code', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.Flavour'),
        ),
        migrations.AddField(
            model_name='amp',
            name='lic_auth',
        ...
        migrations.AddField(
            model_name='amp',
            name='lic_auth_prev',
            field=models.ForeignKey(db_column=b'lic_auth_prevcd', help_text=b'Previous Licensing Authority Code', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='dmd2.LicensingAuthority'),
        ),
        migrations.AddField(
            model_name='amp',
            name='lic_authchange',
            field=models.ForeignKey(db_column=b'lic_authchangecd', help_text=b'Reason for change of licensing authority code', null=True, on_delete=django.db.models.deletion.CASCADE, to='dmd2.LicensingAuthorityChangeReason'),
        ),
        migrations.AddField(
            model_name='amp',
            name='supp',
