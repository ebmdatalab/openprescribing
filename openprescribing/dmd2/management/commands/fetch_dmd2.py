...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        index_url = base_url + 'trud3/user/authenticated/group/0/pack/6/subpack/24/releases'
        ...
        release_date = datetime.strptime(text, 'Released on %A, %d %B %Y').strftime('%Y_%m_%d')
