...
CREATE TEMPORARY FUNCTION
  jsonify_starpu({{ temporary_function_sig }})
  RETURNS STRING
  LANGUAGE js AS '''
  var obj = {};
...
SELECT
  ...
  jsonify_starpu({{ select_starpu }}) AS star_pu
FROM
...
""".strip()
        ...
        ctx = Context({
            'temporary_function_sig': ",".join(temporary_function_sig),
            'temporary_function_obj': ";".join(temporary_function_obj),
            'select_starpu': ",".join(select_starpu),
        },
        autoescape=False)
