...
def setUpModule():
    ...
    dosulepin = Chemical.objects.create(bnf_code='0403010J0',
                                chem_name='Dosulepin Hydrochloride')
    citalopram = Chemical.objects.create(bnf_code='0403030D0',
                                chem_name='Citalopram Hydrobromide')
    Prescription.objects.create(sha=sha, pct=pct, practice=p1, chemical=dosulepin,
    ...
    Prescription.objects.create(sha=sha, pct=pct, practice=p1, chemical=citalopram,
    ...
    Prescription.objects.create(sha=sha, pct=pct, practice=p2, chemical=dosulepin,
                                presentation_code='0403010J0AAAIAI',
                                presentation_name='Dosulepin HCl_Tab 75mg',
                                total_items=34,
                                net_cost=63.79,
                                ...
                                processing_date='2013-09-01',
                                price_per_unit=0.048995884)
    Prescription.objects.create(sha=sha, pct=pct, practice=p2, chemical=citalopram,
