...
class TitleCaseTests(SimpleTestCase):
    def test_variaous_cases(self):
        ...
        tests = [('THING BY THE CHURCH',
                  'Thing by the Church'), ('DR AS RAGHUNATH AND PTNRS',
                                           'Dr AS Raghunath and Ptnrs'),
                 ('OUT OF HOURS', 'Out of Hours'), ('NHS CORBY CCG',
                                                    'NHS Corby CCG'),
                 ('CN HIV THREE BOROUGHS TEAM', 'CN HIV Three Boroughs Team'),
                 ('DMC VICARAGE LANE',
                  'DMC Vicarage Lane'), ('DR CHEUNG KK PRACTICE',
                 ...
                 ("ST ANN'S MEDICAL CENTRE",
                  "St Ann's Medical Centre"), ("C&RH BIGGIN HILL",
                                               "C&RH Biggin Hill")]
