...
class FrontendTest(unittest.TestCase):
    ...
    def test_bnf_chapter_page(self):
        ...
        all_spending_title = self.browser.find_element_by_css_selector(
            '#all-spending .highcharts-title')
        self.assertEqual("Total spending by month", all_spending_title.text)
        detailed_spending_title = self.browser.find_element_by_css_selector(
            '#detailed-spending .highcharts-title')
        self.assertEqual("Spending by chemical by month",
                         detailed_spending_title.text)
    ...
    def test_chemical_page(self):
        ...
        detailed_spending_title = self.browser.find_element_by_css_selector(
            '#detailed-spending .highcharts-title')
        self.assertEqual("Spending by presentation by month",
                         detailed_spending_title.text)
    ...
    def test_ccg_page(self):
        ...
        map_panel = self.browser.find_elements_by_css_selector(
