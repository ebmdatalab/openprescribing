        ...
        migrations.CreateModel(
            ...
            fields=[
                ('message_id', models.CharField(
                    max_length=998, primary_key=True, serialize=False)),
                ...
                ('to', django.contrib.postgres.fields.ArrayField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(
                    choices=[(b'complained', b'complained'), (b'delivered',
                                                              b'delivered'),
                             (b'inbound_failed',
                              b'inbound_failed'), (b'clicked', b'clicked'),
                             (b'opened',
                              b'opened'), (b'subscribed',
                                           b'subscribed'), (b'deferred',
                                                            b'deferred'),
                             (b'inbound',
                              b'inbound'), (b'unknown',
                                            b'unknown'), (b'rejected',
                                                          b'rejected'),
                             (b'queued',
                              b'queued'), (b'failed',
                                           b'failed'), (b'autoresponded',
                                                        b'autoresponded'),
                             (b'unsubscribed',
                              b'unsubscribed'), (b'bounced',
                                                 b'bounced'), (b'sent',
                                                               b'sent')],
                    db_index=True,
                    max_length=15)),
