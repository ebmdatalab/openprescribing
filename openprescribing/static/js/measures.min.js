(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){(function(global){(function(){global.jQuery=require("jquery");global.$=global.jQuery;require("bootstrap");require("Highcharts");require("mapbox.js");var _=require("underscore");var Handlebars=require("handlebars");var utils=require("./src/chart_utils");var formatters=require("./src/chart_formatters");var chartOptions=require("./src/highcharts-options");Highcharts.setOptions({global:{useUTC:false}});L.mapbox.accessToken="pk.eyJ1IjoiYW5uYXBvd2VsbHNtaXRoIiwiYSI6ImNzY1VpYkkifQ.LC_IcHpHfOvWOQCuo5t7Hw";var measures={el:{mapPanel:"map-measure"},setUp:function(){this.setUpShowPractices();var _this=this;_this.NUM_MONTHS_FOR_RANKING=6;_this.centiles=["10","20","30","40","50","60","70","80","90"];_this.measure=measureData.measure;_this.measureIsCostBased=measureData.measureIsCostBased?measureData.measureIsCostBased==="True":null;_this.measureIsPercentage=measureData.measureIsPercentage?measureData.measureIsPercentage==="True":null;_this.orgType=measureData.orgType;_this.parentOrg=measureData.parentOrg?measureData.parentOrg:null;_this.orgId=measureData.orgId;_this.orgName=measureData.orgName;_this.rollUpBy=_this.measure?"org_id":"measure_id";_this.allGraphsRendered=false;_this.graphsToRenderInitially=24;if($("#"+_this.el.mapPanel).length){_this.setUpMap(_this.orgId,_this.orgType)}var summary_template=Handlebars.compile($("#summary-panel").html()),panel_template=Handlebars.compile($("#measure-panel").html());var urls=_this.getDataUrls(_this.orgId,_this.orgType,_this.measure);$.when($.ajax(urls.panelMeasuresUrl),$.ajax(urls.globalMeasuresUrl)).done(function(panelMeasures,globalMeasures){var panelData=panelMeasures[0].measures,globalData=globalMeasures[0].measures,globalSeries={};if(_this.rollUpBy==="org_id"){var series=_.findWhere(globalData,{id:_this.measure});_.each(_this.centiles,function(i){globalSeries[i.toString()]=_this.convertDataForHighcharts(series.data,true,_this.orgType.toLowerCase(),i)});_this.globalYMax=_.max(globalSeries["90"],_.property("y"));_this.globalYMin=_.min(globalSeries["10"],_.property("y"))}else{_this.globalYMax=0;_this.globalYMin=0}panelData=_this.annotateAndSortPanelData(panelData);var perf=_this.getPerformanceSummary(panelData,_this.rollUpBy,_this.measureIsCostBased,_this.orgId,_this.measure);$("#perfsummary").html(summary_template(perf));var html="";var chartData=_this.addChartAttributes(panelData,_this.rollUpBy,_this.orgType,_this.orgId,_this.parentOrg,_this.measure,_this.measureIsCostBased);_.each(chartData,function(d){html+=panel_template(d)});$("#charts").html(html);_.each(chartData,function(d,i){d.data=_this.convertDataForHighcharts(d.data,false);if(_this.rollUpBy==="measure_id"){var series=_.findWhere(globalData,{id:d.id});d.globalSeries={};_.each(_this.centiles,function(i){d.globalSeries[i]=_this.convertDataForHighcharts(series.data,true,_this.orgType.toLowerCase(),i)})}else{d.globalSeries=globalSeries}if(i<_this.graphsToRenderInitially){_this.renderGraph(d,_this.orgType,_this.measureIsPercentage)}});$(window).scroll(function(){if(_this.allGraphsRendered===false){_.each(chartData,function(d,i){if(i>=_this.graphsToRenderInitially){_this.renderGraph(d,_this.orgType,_this.measureIsPercentage)}});_this.allGraphsRendered=true}});if(_this.rollUpBy==="measure_id"){var chartsByPercentile=$("#charts .chart");var chartsBySaving=$(chartsByPercentile).filter(function(a){return $(this).data("costsaving")!==0});chartsBySaving.sort(function(a,b){return+a.costsaving-+b.costsaving});$(".btn-group > .btn").click(function(){$(this).addClass("active").siblings().removeClass("active");if($(this).data("orderby")==="savings"){$("#charts").fadeOut(function(){$("#charts").html(chartsBySaving).fadeIn()})}else{$("#charts").fadeOut(function(){$("#charts").html(chartsByPercentile).fadeIn()})}})}}).fail(function(){console.log("data failed")})},getDataUrls:function(orgId,orgType,measure){var urls={panelMeasuresUrl:"/api/1.0/measure_by_"+orgType.toLowerCase()+"/?format=json",globalMeasuresUrl:"/api/1.0/measure/?format=json"};if(orgId){urls.panelMeasuresUrl+="&org="+orgId}if(measure){urls.panelMeasuresUrl+="&measure="+measure;urls.globalMeasuresUrl+="&measure="+measure}return urls},renderGraph:function(d,orgType,isPercentageMeasure){var _this=this;if(d.data.length){var hcOptions=_this.getChartOptions(d,isPercentageMeasure);hcOptions.series=[{name:"This "+orgType,is_national_series:false,data:d.data,color:"red",marker:{radius:2}}];for(var k in d.globalSeries){var e={name:k+"th percentile nationally",is_national_series:true,data:d.globalSeries[k],dashStyle:"dot",color:"blue",lineWidth:1,marker:{enabled:false}};if(k==="50"){e.dashStyle="longdash"}hcOptions.series.push(e)}var chart=new Highcharts.Chart(hcOptions)}else{$("#"+chartOptions.chartId).find(_this.el.status).html("No data found for this "+_this.orgType).show()}},annotateAndSortPanelData:function(panelData){var data,_this=this;if(_this.rollUpBy!=="measure_id"){panelData=_this.rollUpByOrg(panelData[0],_this.orgType)}panelData=_this.getSavingAndPercentilePerItem(panelData,_this.NUM_MONTHS_FOR_RANKING);data=_.sortBy(panelData,function(d){if(d.mean_percentile===null)return-1;return d.mean_percentile}).reverse();return data},_parseDate:function(d){var dates=d.split("-");return Date.UTC(dates[0],dates[1]-1,dates[2])},convertDataForHighcharts:function(data,is_global,org,num){var _this=this,dataCopy=JSON.parse(JSON.stringify(data));_.each(dataCopy,function(d,i){d.x=_this._parseDate(d.date);p=d.percentiles;if(is_global){d.y=p&&p[org]&&p[org][num]!==null?parseFloat(p[org][num]):null}else{d.y=d.calc_value!==null?parseFloat(d.calc_value):null}if(_this.measureIsPercentage){d.y=d.y*100}});return dataCopy},rollUpByOrg:function(data,orgType){var rolled={};_.each(data.data,function(d){var id=orgType==="practice"?d.practice_id:d.pct_id,name=orgType==="practice"?d.practice_name:d.pct_name;if(id in rolled){rolled[id].data.push(d)}else{rolled[id]={id:id,name:name,numerator_short:data.numerator_short,denominator_short:data.denominator_short,data:[d],description:""}}});var rolledArr=[];for(var org_id in rolled){rolledArr.push(rolled[org_id])}return rolledArr},getSavingAndPercentilePerItem:function(data,num_months){_.each(data,function(d){var latestData=d.data.slice(num_months*-1);var sum=_.reduce(latestData,function(memo,num){return num.percentile===null?memo:memo+num.percentile},null);d.mean_percentile=sum!==null?sum/latestData.length:null;d.cost_saving_50th=_.reduce(latestData,function(memo,num){var saving=num.cost_savings?num.cost_savings["50"]:null;return memo+saving},null)});return data},addChartAttributes:function(data,rollUpBy,orgType,orgId,parentOrg,measure,measureIsCostBased){var _this=this;_.each(data,function(d){d.chart_id=d.id;if(rollUpBy==="measure_id"){d.chart_title=d.name;d.chart_title_url="/ccg/";d.chart_title_url+=parentOrg?parentOrg:orgId;d.chart_title_url+="/"+d.id}else{d.chart_title=d.id+": "+d.name;d.chart_title_url="/"+orgType.toLowerCase()+"/"+d.id+"/measures"}d.description_short=d.description.substring(0,80)+" ...";if(d.is_cost_based||measureIsCostBased){d.cost_description="";if(d.cost_saving_50th<0){d.cost_description+="<strong>Cost savings:</strong> ";d.cost_description+="By prescribing better than the median, ";d.cost_description+="this "+orgType+" has saved the NHS £";d.cost_description+=Highcharts.numberFormat(d.cost_saving_50th*-1,2);d.cost_description+=" over the past six months."}else if(d.cost_saving_50th===0){}else{d.cost_description+="<strong>Cost savings:</strong> ";d.cost_description+="If it had prescribed in line with the median, ";d.cost_description+="this "+orgType+" would have spent £";d.cost_description+=Highcharts.numberFormat(d.cost_saving_50th,2);d.cost_description+=" less over the past six months."}d.chart_explanation=d.cost_description}else{if(d.mean_percentile){var p=Highcharts.numberFormat(d.mean_percentile,0);d.chart_explanation="This organisation was at the ";d.chart_explanation+=p+_this.getOrdinalSuffix(p);d.chart_explanation+=" percentile on average across the past six months."}else{d.chart_explanation="No data available."}}});return data},getChartOptions:function(d,isPercentageMeasure){var _this=this,options=$.extend(true,{},chartOptions.dashOptions),localMax=_.max(d.data,_.property("y")),localMin=_.min(d.data,_.property("y")),ymax,ymin;isPercentageMeasure=d.is_percentage||isPercentageMeasure;options.chart.renderTo=d.chart_id;options.chart.height=200;options.legend.enabled=false;if(_this.rollUpBy==="org_id"){ymax=_.max([localMax.y,_this.globalYMax.y]);ymin=_.min([localMin.y,_this.globalYMin.y])}else{var local90thMax=_.max(d.globalSeries["90"],_.property("y"));ymax=_.max([localMax.y,local90thMax.y]);var local90thMin=_.min(d.globalSeries["10"],_.property("y"));ymin=_.min([localMin.y,local90thMin.y])}var yAxisLabel=isPercentageMeasure?"%":"Measure";options.yAxis={title:{text:yAxisLabel},max:ymax,min:_.max([0,ymin])};options.tooltip={formatter:function(){var num=Highcharts.numberFormat(this.point.numerator,0),denom=Highcharts.numberFormat(this.point.denominator,0),percentile=Highcharts.numberFormat(this.point.percentile,0),str="";str+="<b>"+this.series.name;str+=" in "+Highcharts.dateFormat("%b '%y",new Date(this.x));str+="</b><br/>";if(!this.series.options.is_national_series){str+=d.numerator_short+": "+num;str+="<br/>";str+=d.denominator_short+": "+denom;str+="<br/>"}str+="Measure: "+Highcharts.numberFormat(this.point.y,3);str+=isPercentageMeasure?"%":"";if(!this.series.options.is_national_series){str+=" ("+percentile+_this.getOrdinalSuffix(percentile)+" percentile)"}return str}};return options},getOrdinalSuffix:function(percentile){var lastChar=percentile.toString().slice(-1),suffix;switch(lastChar){case"1":suffix=percentile=="11"?"th":"st";break;case"2":suffix=percentile=="12"?"th":"nd";break;case"3":suffix=percentile=="13"?"th":"rd";break;default:suffix="th"}return suffix},getPerformanceSummary:function(orderedData,rollUpBy,isCostBased,orgId,measure){var perf={total:0,above_median:0,potential_savings_50th:0,potential_savings_10th:0,org_id:orgId,measure_id:measure};if(orderedData.length){_.each(orderedData,function(d){if(d.mean_percentile!==null){perf.total+=1;if(d.mean_percentile>50){perf.above_median+=1;perf.potential_savings_50th+=isCostBased?d.cost_saving_50th:0}if(d.mean_percentile>10){perf.potential_savings_10th+=isCostBased?d.cost_saving_10th:0}}});perf.performance_description="Over the past six months, this organisation ";perf.performance_description+="has prescribed above the median on ";perf.performance_description+=perf.above_median+" of "+perf.total+" measures.";perf.proportion_above_median=perf.above_median/perf.total;if(perf.proportion_above_median>=.75){perf.rank="poor"}else if(perf.proportion_above_median>=.5){perf.rank="acceptable"}else if(perf.proportion_above_median>=.25){perf.rank="good"}else if(perf.proportion_above_median>=0){perf.rank="very good"}if(perf.performance_description){perf.performance_description+=" We think this is "+perf.rank;perf.performance_description+=" performance overall."}var p=Highcharts.numberFormat(orderedData[0].mean_percentile,0);perf.top_opportunity="The measure with the biggest potential for improvement was ";perf.top_opportunity+=orderedData[0].name+", where this "+this.orgType;perf.top_opportunity+=" was at the "+p+this.getOrdinalSuffix(p);perf.top_opportunity+=" percentile on average across the past six months.";perf.proportion_above_median=Highcharts.numberFormat(perf.proportion_above_median*100,1);if(isCostBased){if(rollUpBy==="measure_id"){perf.cost_savings="Over the past six months, if this ";perf.cost_savings+=this.orgType==="practice"?"practice ":"CCG ";perf.cost_savings+=" had prescribed ";perf.cost_savings+="at the median ratio or better on all cost-saving measures below, then it would ";perf.cost_savings+="have spent £"+Highcharts.numberFormat(perf.potential_savings_50th,2);perf.cost_savings+=" less. (We use the national median as a suggested ";perf.cost_savings+="target because by definition, 50% of practices were already prescribing ";perf.cost_savings+="at this level or better, so we think it ought to be achievable.)"}else{perf.cost_savings="Over the past six months, if all ";perf.cost_savings+=this.orgType==="practice"?"practices ":"CCGs ";perf.cost_savings+="had prescribed at the median ratio or better, then ";perf.cost_savings+=this.orgType==="practice"?"this CCG ":"NHS England ";perf.cost_savings+="would have spent £"+Highcharts.numberFormat(perf.potential_savings_50th,2);perf.cost_savings+=" less. (We use the national median as a suggested ";perf.cost_savings+="target because by definition, 50% of ";perf.cost_savings+=this.orgType==="practice"?"practices ":"CCGs ";perf.cost_savings+=" were already prescribing ";perf.cost_savings+="at this level or better, so we think it ought to be achievable.)"}}}else{perf.performance_description="This organisation hasn't prescribed on any of these measures."}return perf},setUpShowPractices:function(){$("#showall").on("click",function(e){e.preventDefault();$("#practices li.hidden").each(function(i,item){$(item).removeClass("hidden")});$(this).hide()})},setUpMap:function(orgId,orgType){var _this=this;var map=L.mapbox.map(_this.el.mapPanel,"mapbox.streets").setView([52.905,-1.79],6);map.scrollWheelZoom.disable();var url="/api/1.0/org_location/?org_type="+orgType.toLowerCase();url+="&q="+orgId;var layer=L.mapbox.featureLayer().loadURL(url).on("ready",function(){if(layer.getBounds().isValid()){map.fitBounds(layer.getBounds(),{maxZoom:12});layer.setStyle({fillColor:"#ff00ff",fillOpacity:.2,weight:.5,color:"#333",radius:10})}else{$("#map-container").html("")}}).addTo(map)}};measures.setUp()})()}).call(this,typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{})},{"./src/chart_formatters":95,"./src/chart_utils":96,"./src/highcharts-options":97,Highcharts:98,bootstrap:3,handlebars:47,jquery:49,"mapbox.js":61,underscore:94}],2:[function(require,module,exports){(function(process,__filename){"use strict";function amdefine(module,requireFn){"use strict";var defineCache={},loaderCache={},alreadyCalled=false,path=require("path"),makeRequire,stringRequire;function trimDots(ary){var i,part;for(i=0;ary[i];i+=1){part=ary[i];if(part==="."){ary.splice(i,1);i-=1}else if(part===".."){if(i===1&&(ary[2]===".."||ary[0]==="..")){break}else if(i>0){ary.splice(i-1,2);i-=2}}}}function normalize(name,baseName){var baseParts;if(name&&name.charAt(0)==="."){if(baseName){baseParts=baseName.split("/");baseParts=baseParts.slice(0,baseParts.length-1);baseParts=baseParts.concat(name.split("/"));trimDots(baseParts);name=baseParts.join("/")}}return name}function makeNormalize(relName){return function(name){return normalize(name,relName)}}function makeLoad(id){function load(value){loaderCache[id]=value}load.fromText=function(id,text){throw new Error("amdefine does not implement load.fromText")};return load}makeRequire=function(systemRequire,exports,module,relId){function amdRequire(deps,callback){if(typeof deps==="string"){return stringRequire(systemRequire,exports,module,deps,relId)}else{deps=deps.map(function(depName){return stringRequire(systemRequire,exports,module,depName,relId)});if(callback){process.nextTick(function(){callback.apply(null,deps)})}}}amdRequire.toUrl=function(filePath){if(filePath.indexOf(".")===0){return normalize(filePath,path.dirname(module.filename))}else{return filePath}};return amdRequire};requireFn=requireFn||function req(){return module.require.apply(module,arguments)};function runFactory(id,deps,factory){var r,e,m,result;if(id){e=loaderCache[id]={};m={id:id,uri:__filename,exports:e};r=makeRequire(requireFn,e,m,id)}else{if(alreadyCalled){throw new Error("amdefine with no module ID cannot be called more than once per file.")}alreadyCalled=true;e=module.exports;m=module;r=makeRequire(requireFn,e,m,module.id)}if(deps){deps=deps.map(function(depName){return r(depName)})}if(typeof factory==="function"){result=factory.apply(m.exports,deps)}else{result=factory}if(result!==undefined){m.exports=result;if(id){loaderCache[id]=m.exports}}}stringRequire=function(systemRequire,exports,module,id,relId){var index=id.indexOf("!"),originalId=id,prefix,plugin;if(index===-1){id=normalize(id,relId);if(id==="require"){return makeRequire(systemRequire,exports,module,relId)}else if(id==="exports"){return exports}else if(id==="module"){return module}else if(loaderCache.hasOwnProperty(id)){return loaderCache[id]}else if(defineCache[id]){runFactory.apply(null,defineCache[id]);return loaderCache[id]}else{if(systemRequire){return systemRequire(originalId)}else{throw new Error("No module with ID: "+id)}}}else{prefix=id.substring(0,index);id=id.substring(index+1,id.length);plugin=stringRequire(systemRequire,exports,module,prefix,relId);if(plugin.normalize){id=plugin.normalize(id,makeNormalize(relId))}else{id=normalize(id,relId)}if(loaderCache[id]){return loaderCache[id]}else{plugin.load(id,makeRequire(systemRequire,exports,module,relId),makeLoad(id),{});return loaderCache[id]}}};function define(id,deps,factory){if(Array.isArray(id)){factory=deps;deps=id;id=undefined}else if(typeof id!=="string"){factory=id;id=deps=undefined}if(deps&&!Array.isArray(deps)){factory=deps;deps=undefined}if(!deps){deps=["require","exports","module"]}if(id){defineCache[id]=[id,deps,factory]}else{runFactory(id,deps,factory)}}define.require=function(id){if(loaderCache[id]){return loaderCache[id]}if(defineCache[id]){runFactory.apply(null,defineCache[id]);return loaderCache[id]}};define.amd={};return define}module.exports=amdefine}).call(this,require("_process"),"/node_modules/amdefine/amdefine.js")},{_process:79,path:78}],3:[function(require,module,exports){require("../../js/transition.js");require("../../js/alert.js");require("../../js/button.js");require("../../js/carousel.js");require("../../js/collapse.js");require("../../js/dropdown.js");require("../../js/modal.js");require("../../js/tooltip.js");require("../../js/popover.js");require("../../js/scrollspy.js");require("../../js/tab.js");require("../../js/affix.js")},{"../../js/affix.js":4,"../../js/alert.js":5,"../../js/button.js":6,"../../js/carousel.js":7,"../../js/collapse.js":8,"../../js/dropdown.js":9,"../../js/modal.js":10,"../../js/popover.js":11,"../../js/scrollspy.js":12,"../../js/tab.js":13,"../../js/tooltip.js":14,"../../js/transition.js":15}],4:[function(require,module,exports){+function($){"use strict";var Affix=function(element,options){this.options=$.extend({},Affix.DEFAULTS,options);this.$target=$(this.options.target).on("scroll.bs.affix.data-api",$.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",$.proxy(this.checkPositionWithEventLoop,this));this.$element=$(element);this.affixed=null;this.unpin=null;this.pinnedOffset=null;this.checkPosition()};Affix.VERSION="3.3.6";Affix.RESET="affix affix-top affix-bottom";Affix.DEFAULTS={offset:0,target:window};Affix.prototype.getState=function(scrollHeight,height,offsetTop,offsetBottom){var scrollTop=this.$target.scrollTop();var position=this.$element.offset();var targetHeight=this.$target.height();if(offsetTop!=null&&this.affixed=="top")return scrollTop<offsetTop?"top":false;if(this.affixed=="bottom"){if(offsetTop!=null)return scrollTop+this.unpin<=position.top?false:"bottom";return scrollTop+targetHeight<=scrollHeight-offsetBottom?false:"bottom"}var initializing=this.affixed==null;var colliderTop=initializing?scrollTop:position.top;var colliderHeight=initializing?targetHeight:height;if(offsetTop!=null&&scrollTop<=offsetTop)return"top";if(offsetBottom!=null&&colliderTop+colliderHeight>=scrollHeight-offsetBottom)return"bottom";return false};Affix.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(Affix.RESET).addClass("affix");var scrollTop=this.$target.scrollTop();var position=this.$element.offset();return this.pinnedOffset=position.top-scrollTop};Affix.prototype.checkPositionWithEventLoop=function(){setTimeout($.proxy(this.checkPosition,this),1)};Affix.prototype.checkPosition=function(){if(!this.$element.is(":visible"))return;var height=this.$element.height();var offset=this.options.offset;var offsetTop=offset.top;var offsetBottom=offset.bottom;var scrollHeight=Math.max($(document).height(),$(document.body).height());if(typeof offset!="object")offsetBottom=offsetTop=offset;if(typeof offsetTop=="function")offsetTop=offset.top(this.$element);if(typeof offsetBottom=="function")offsetBottom=offset.bottom(this.$element);var affix=this.getState(scrollHeight,height,offsetTop,offsetBottom);if(this.affixed!=affix){if(this.unpin!=null)this.$element.css("top","");var affixType="affix"+(affix?"-"+affix:"");var e=$.Event(affixType+".bs.affix");this.$element.trigger(e);if(e.isDefaultPrevented())return;this.affixed=affix;this.unpin=affix=="bottom"?this.getPinnedOffset():null;this.$element.removeClass(Affix.RESET).addClass(affixType).trigger(affixType.replace("affix","affixed")+".bs.affix")}if(affix=="bottom"){this.$element.offset({top:scrollHeight-height-offsetBottom})}};function Plugin(option){return this.each(function(){var $this=$(this);var data=$this.data("bs.affix");var options=typeof option=="object"&&option;if(!data)$this.data("bs.affix",data=new Affix(this,options));if(typeof option=="string")data[option]()})}var old=$.fn.affix;$.fn.affix=Plugin;$.fn.affix.Constructor=Affix;$.fn.affix.noConflict=function(){$.fn.affix=old;return this};$(window).on("load",function(){$('[data-spy="affix"]').each(function(){var $spy=$(this);var data=$spy.data();data.offset=data.offset||{};if(data.offsetBottom!=null)data.offset.bottom=data.offsetBottom;if(data.offsetTop!=null)data.offset.top=data.offsetTop;Plugin.call($spy,data)})})}(jQuery)},{}],5:[function(require,module,exports){+function($){"use strict";var dismiss='[data-dismiss="alert"]';var Alert=function(el){$(el).on("click",dismiss,this.close)};Alert.VERSION="3.3.6";Alert.TRANSITION_DURATION=150;Alert.prototype.close=function(e){var $this=$(this);var selector=$this.attr("data-target");if(!selector){selector=$this.attr("href");selector=selector&&selector.replace(/.*(?=#[^\s]*$)/,"")}var $parent=$(selector);if(e)e.preventDefault();if(!$parent.length){$parent=$this.closest(".alert")}$parent.trigger(e=$.Event("close.bs.alert"));if(e.isDefaultPrevented())return;$parent.removeClass("in");function removeElement(){$parent.detach().trigger("closed.bs.alert").remove()}$.support.transition&&$parent.hasClass("fade")?$parent.one("bsTransitionEnd",removeElement).emulateTransitionEnd(Alert.TRANSITION_DURATION):removeElement()};function Plugin(option){return this.each(function(){var $this=$(this);var data=$this.data("bs.alert");if(!data)$this.data("bs.alert",data=new Alert(this));if(typeof option=="string")data[option].call($this)})}var old=$.fn.alert;$.fn.alert=Plugin;$.fn.alert.Constructor=Alert;$.fn.alert.noConflict=function(){$.fn.alert=old;return this};$(document).on("click.bs.alert.data-api",dismiss,Alert.prototype.close)}(jQuery)},{}],6:[function(require,module,exports){+function($){"use strict";var Button=function(element,options){this.$element=$(element);this.options=$.extend({},Button.DEFAULTS,options);this.isLoading=false};Button.VERSION="3.3.6";Button.DEFAULTS={loadingText:"loading..."};Button.prototype.setState=function(state){var d="disabled";var $el=this.$element;var val=$el.is("input")?"val":"html";var data=$el.data();state+="Text";if(data.resetText==null)$el.data("resetText",$el[val]());setTimeout($.proxy(function(){$el[val](data[state]==null?this.options[state]:data[state]);if(state=="loadingText"){this.isLoading=true;$el.addClass(d).attr(d,d)}else if(this.isLoading){this.isLoading=false;$el.removeClass(d).removeAttr(d)}},this),0)};Button.prototype.toggle=function(){var changed=true;var $parent=this.$element.closest('[data-toggle="buttons"]');if($parent.length){var $input=this.$element.find("input");if($input.prop("type")=="radio"){if($input.prop("checked"))changed=false;$parent.find(".active").removeClass("active");this.$element.addClass("active")}else if($input.prop("type")=="checkbox"){if($input.prop("checked")!==this.$element.hasClass("active"))changed=false;this.$element.toggleClass("active")}$input.prop("checked",this.$element.hasClass("active"));if(changed)$input.trigger("change")}else{this.$element.attr("aria-pressed",!this.$element.hasClass("active"));this.$element.toggleClass("active")}};function Plugin(option){return this.each(function(){var $this=$(this);var data=$this.data("bs.button");var options=typeof option=="object"&&option;if(!data)$this.data("bs.button",data=new Button(this,options));if(option=="toggle")data.toggle();else if(option)data.setState(option)})}var old=$.fn.button;$.fn.button=Plugin;$.fn.button.Constructor=Button;$.fn.button.noConflict=function(){$.fn.button=old;return this};$(document).on("click.bs.button.data-api",'[data-toggle^="button"]',function(e){var $btn=$(e.target);if(!$btn.hasClass("btn"))$btn=$btn.closest(".btn");Plugin.call($btn,"toggle");if(!($(e.target).is('input[type="radio"]')||$(e.target).is('input[type="checkbox"]')))e.preventDefault()}).on("focus.bs.button.data-api blur.bs.button.data-api",'[data-toggle^="button"]',function(e){$(e.target).closest(".btn").toggleClass("focus",/^focus(in)?$/.test(e.type))})}(jQuery)},{}],7:[function(require,module,exports){+function($){"use strict";var Carousel=function(element,options){this.$element=$(element);this.$indicators=this.$element.find(".carousel-indicators");this.options=options;this.paused=null;this.sliding=null;this.interval=null;this.$active=null;this.$items=null;this.options.keyboard&&this.$element.on("keydown.bs.carousel",$.proxy(this.keydown,this));this.options.pause=="hover"&&!("ontouchstart"in document.documentElement)&&this.$element.on("mouseenter.bs.carousel",$.proxy(this.pause,this)).on("mouseleave.bs.carousel",$.proxy(this.cycle,this))};Carousel.VERSION="3.3.6";Carousel.TRANSITION_DURATION=600;Carousel.DEFAULTS={interval:5e3,pause:"hover",wrap:true,keyboard:true};Carousel.prototype.keydown=function(e){if(/input|textarea/i.test(e.target.tagName))return;switch(e.which){case 37:this.prev();break;case 39:this.next();break;default:return}e.preventDefault()};Carousel.prototype.cycle=function(e){e||(this.paused=false);this.interval&&clearInterval(this.interval);this.options.interval&&!this.paused&&(this.interval=setInterval($.proxy(this.next,this),this.options.interval));return this};Carousel.prototype.getItemIndex=function(item){this.$items=item.parent().children(".item");return this.$items.index(item||this.$active)};Carousel.prototype.getItemForDirection=function(direction,active){var activeIndex=this.getItemIndex(active);var willWrap=direction=="prev"&&activeIndex===0||direction=="next"&&activeIndex==this.$items.length-1;if(willWrap&&!this.options.wrap)return active;var delta=direction=="prev"?-1:1;var itemIndex=(activeIndex+delta)%this.$items.length;return this.$items.eq(itemIndex)};Carousel.prototype.to=function(pos){var that=this;var activeIndex=this.getItemIndex(this.$active=this.$element.find(".item.active"));if(pos>this.$items.length-1||pos<0)return;if(this.sliding)return this.$element.one("slid.bs.carousel",function(){that.to(pos)});if(activeIndex==pos)return this.pause().cycle();return this.slide(pos>activeIndex?"next":"prev",this.$items.eq(pos))};Carousel.prototype.pause=function(e){e||(this.paused=true);if(this.$element.find(".next, .prev").length&&$.support.transition){this.$element.trigger($.support.transition.end);this.cycle(true)}this.interval=clearInterval(this.interval);return this};Carousel.prototype.next=function(){if(this.sliding)return;return this.slide("next")};Carousel.prototype.prev=function(){if(this.sliding)return;return this.slide("prev")};Carousel.prototype.slide=function(type,next){var $active=this.$element.find(".item.active");var $next=next||this.getItemForDirection(type,$active);var isCycling=this.interval;var direction=type=="next"?"left":"right";var that=this;if($next.hasClass("active"))return this.sliding=false;var relatedTarget=$next[0];var slideEvent=$.Event("slide.bs.carousel",{relatedTarget:relatedTarget,direction:direction});this.$element.trigger(slideEvent);if(slideEvent.isDefaultPrevented())return;this.sliding=true;isCycling&&this.pause();if(this.$indicators.length){this.$indicators.find(".active").removeClass("active");var $nextIndicator=$(this.$indicators.children()[this.getItemIndex($next)]);$nextIndicator&&$nextIndicator.addClass("active")}var slidEvent=$.Event("slid.bs.carousel",{relatedTarget:relatedTarget,direction:direction});if($.support.transition&&this.$element.hasClass("slide")){$next.addClass(type);$next[0].offsetWidth;$active.addClass(direction);$next.addClass(direction);$active.one("bsTransitionEnd",function(){$next.removeClass([type,direction].join(" ")).addClass("active");$active.removeClass(["active",direction].join(" "));that.sliding=false;setTimeout(function(){that.$element.trigger(slidEvent)},0)}).emulateTransitionEnd(Carousel.TRANSITION_DURATION)}else{$active.removeClass("active");$next.addClass("active");this.sliding=false;this.$element.trigger(slidEvent)}isCycling&&this.cycle();return this};function Plugin(option){return this.each(function(){var $this=$(this);var data=$this.data("bs.carousel");var options=$.extend({},Carousel.DEFAULTS,$this.data(),typeof option=="object"&&option);var action=typeof option=="string"?option:options.slide;if(!data)$this.data("bs.carousel",data=new Carousel(this,options));if(typeof option=="number")data.to(option);else if(action)data[action]();else if(options.interval)data.pause().cycle()})}var old=$.fn.carousel;$.fn.carousel=Plugin;$.fn.carousel.Constructor=Carousel;$.fn.carousel.noConflict=function(){$.fn.carousel=old;return this};var clickHandler=function(e){var href;var $this=$(this);var $target=$($this.attr("data-target")||(href=$this.attr("href"))&&href.replace(/.*(?=#[^\s]+$)/,""));if(!$target.hasClass("carousel"))return;var options=$.extend({},$target.data(),$this.data());var slideIndex=$this.attr("data-slide-to");if(slideIndex)options.interval=false;Plugin.call($target,options);if(slideIndex){$target.data("bs.carousel").to(slideIndex)}e.preventDefault()};$(document).on("click.bs.carousel.data-api","[data-slide]",clickHandler).on("click.bs.carousel.data-api","[data-slide-to]",clickHandler);$(window).on("load",function(){$('[data-ride="carousel"]').each(function(){var $carousel=$(this);Plugin.call($carousel,$carousel.data())})})}(jQuery)},{}],8:[function(require,module,exports){+function($){"use strict";var Collapse=function(element,options){this.$element=$(element);this.options=$.extend({},Collapse.DEFAULTS,options);this.$trigger=$('[data-toggle="collapse"][href="#'+element.id+'"],'+'[data-toggle="collapse"][data-target="#'+element.id+'"]');this.transitioning=null;if(this.options.parent){this.$parent=this.getParent()}else{this.addAriaAndCollapsedClass(this.$element,this.$trigger)}if(this.options.toggle)this.toggle()};Collapse.VERSION="3.3.6";Collapse.TRANSITION_DURATION=350;Collapse.DEFAULTS={toggle:true};Collapse.prototype.dimension=function(){var hasWidth=this.$element.hasClass("width");return hasWidth?"width":"height"};Collapse.prototype.show=function(){if(this.transitioning||this.$element.hasClass("in"))return;var activesData;var actives=this.$parent&&this.$parent.children(".panel").children(".in, .collapsing");if(actives&&actives.length){activesData=actives.data("bs.collapse");if(activesData&&activesData.transitioning)return}var startEvent=$.Event("show.bs.collapse");this.$element.trigger(startEvent);if(startEvent.isDefaultPrevented())return;
