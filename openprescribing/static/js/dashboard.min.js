(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){var measures=[{chartId:"rosuvastatin",chartName:"Rosuvastatin Calcium vs. Atorvastatin",chartIntro:'Prescribing of <a href="/chemical/0212000AA">Rosuvastatin Calcium (BNF code 0212000AA)</a>, compared with <a href="/chemical/0212000B0">Atorvastatin (BNF code 0212000B0)</a>.',chartDescription:"Statins are the most commonly prescribed class of drug in the UK. Atorvastatin and Rosuvastatin are members of this class, and are both high-potency statins. There will always be reasons why occasional patients do better with a particular drug, but overall there is no good evidence that Rosuvastatin is better than atorvastatin. It is, however, vastly more expensive. When atorvastatin came off patent, and became cheap, practices tended to switch people away from expensive Rosuvastatin.",numIds:[{id:"0212000AA",name:"Rosuvastatin"}],denomIds:[{id:"0212000B0",name:"Atorvastatin"}]},{chartId:"cerazette",chartName:"Cerazette vs. Desogestrel",chartIntro:'Prescribing of branded Cerazette (BNF code 0703021Q0BB) compared with prescribing of <a href="/chemical/0703021Q0">all Desogestrel (BNF code 0703021Q0)</a>.',chartDescription:"This is the NHS Business Service Authority's top cost-saver from generic switching. Cerazette and desogestrel are both exactly the same drug, the same molecule, but Cerazette is an expensive branded package, and desogestrel is a cheap generic package.",numIds:[{id:"0703021Q0BB",name:"Cerazette"}],denomIds:[{id:"0703021Q0",name:"Desogestrel"}]},{chartId:"cephalosporins",chartName:"Cephalosporins per oral antibiotics STAR-PU",chartIntro:'Prescribing of <a href="/bnf/050102">Cephalosporins (BNF section 5.1.2)</a> compared with item-based STAR-PUs for oral antibiotics.',chartDescription:"Cephalosporins are broad spectrum antibiotics which can be used when others have failed. It is important that they are used sparingly, to avoid drug-resistant bacteria developing. This measure looks at the quantity of cephalosporins prescribed per head of population, corrected for the age and sex distribution of that population.",numIds:[{id:"050102",name:"Cephalosporins and other Beta-Lactams"}],denom:"star_pu.oral_antibacterials_item",denomIds:[]},{chartId:"antibiotics",chartName:"All antibacterial drugs per oral antibiotics STAR-PU",chartIntro:'Prescribing of <a href="/bnf/0501">Antibacterial Drugs (BNF section 5.1)</a> compared with item-based STAR-PUs for oral antibiotics.',chartDescription:"It is important that we don't overuse antibiotics. This shows how many are being prescribed locally.",numIds:[{id:"0501",name:"Antibacterial Drugs"}],denom:"star_pu.oral_antibacterials_item",denomIds:[]},{chartId:"pioglitazone",chartName:"Pioglitazone Hydrochloride vs. all Antidiabetic Drugs",chartIntro:'Prescribing of <a href="/chemical/0601023B0">Pioglitazone Hydrochloride (BNF code 0601023B0)</a> compared with prescribing of all <a href="/bnf/060102">Antidiabetic Drugs</a> (BNF code 6.1.2).',chartDescription:'Rosiglitazone is an antidiabetic drug that turned out to increase the risk of heart problems, and was effectively withdrawn from the market. There is concern that the problems may have been a "class effect", covering other related drugs, and so doctors have tended to also stop using pioglitazone. This shows how local practice reflects that national trend.',numIds:[{id:"0601023B0",name:"Pioglitazone Hydrochloride"}],denomIds:[{id:"060102",name:"All diabetes"}]},{chartId:"celecoxib",chartName:"Celecoxib vs. all NSAIDs",chartIntro:'Prescribing of <a href="/chemical/0801050AY">Celecoxib (BNF code 0801050AY)</a> and <a href="/chemical/1001010AH">Celecoxib (BNF code 1001010AH)</a> compared with prescribing of all <a href="/bnf/100101">Non-Steroidal Anti-Inflammatory Drugs</a> (BNF section 1.1.1).',chartDescription:"Coxib drugs are an interesting illustration of a common phenomenon in medicine: the need to make a trade off between risk and benefit, in different patients. Long term use of NSAID painkillers puts patients at increased risk of gastric bleeds. Coxib painkillers are effective at treating pain, with lower risk of bleeding; but they are much more expensive, and come with a higher risk of cardiovascular problems. Overall, therefore, they are sensible to use in some patients, but if one area is prescribing a lot of coxibs (or very few) then that may mean that they have unusual patients, or it may mean that doctors' thresholds for using them are different to their colleagues nationally.",numIds:[{id:"0801050AY",name:"Celecoxib"},{id:"1001010AH",name:"Celecoxib"}],denomIds:[{id:"100101",name:"Non-Steroidal Anti-Inflammatory Drugs"}]}];module.exports=measures},{}],2:[function(require,module,exports){(function(global){(function(){global.jQuery=require("jquery");global.$=global.jQuery;require("bootstrap");require("Highcharts");require("mapbox.js");var _=require("underscore");var Handlebars=require("handlebars");var measures=require("./dashboard-measures");var utils=require("./src/chart_utils");var formatters=require("./src/chart_formatters");var chartOptions=require("./src/highcharts-options");Highcharts.setOptions({global:{useUTC:false}});L.mapbox.accessToken="pk.eyJ1IjoiYW5uYXBvd2VsbHNtaXRoIiwiYSI6ImNzY1VpYkkifQ.LC_IcHpHfOvWOQCuo5t7Hw";var dashboard={el:{noData:"",status:".status",trendsPanel:"#trends",mapPanel:"map-ccg"},errorMessage:"<p>Sorry, something went wrong.</p>",setUp:function(){this.setUpShowPractices();var _this=this;_this.orgId=orgId;_this.orgName=orgName;_this.orgType=orgType;_this.baseUrl="/api/1.0/";_this.spendUrl=_this.baseUrl;_this.spendUrl+=_this.orgType==="CCG"?"spending_by_ccg":"spending_by_practice";this.setUpMap(_this.orgId,_this.orgType);var metric_panel_source=$("#metric-panel").html();var metric_panel_template=Handlebars.compile(metric_panel_source);var metric_explanation_source=$("#metric-explanation").html();var metric_explanation_template=Handlebars.compile(metric_explanation_source);_.each(measures,function(m){var data={metric_id:m.chartId,metric_intro:m.chartIntro,metric_name:m.chartName,metric_description:m.chartDescription,org_name:_this.orgName,org_type:_this.orgType};function getUrl(d){var url="&numIds=";_.each(d.numIds,function(numId,i){url+=numId.id;url+=i<d.numIds.length-1?",":""});if(d.denomIds.length){url+="&denomIds=";_.each(d.denomIds,function(denomId,i){url+=denomId.id;url+=i<d.denomIds.length-1?",":""})}else{url+="&denom="+d.denom}return url}if(_this.orgType=="CCG"){data.metric_footer='<a href="/analyse#';data.metric_footer+="org=CCG&orgIds="+this.orgId;data.metric_footer+=getUrl(m);data.metric_footer+='">how this CCG compares to all CCGs</a>, or ';data.metric_footer+='<a href="/analyse#org=practice&orgIds='+this.orgId;data.metric_footer+=getUrl(m);data.metric_footer+='">trends for all ';data.metric_footer+="practices in the same CCG</a>"}else{data.metric_footer='<a href="/analyse#';data.metric_footer+="org=practice&orgIds="+this.orgId;data.metric_footer+=getUrl(m);data.metric_footer+='">how this practice compares to all ';data.metric_footer+="practices in the same CCG</a>"}var r=metric_panel_template(data);$("#metric-panels").append(r);r=metric_explanation_template(data);$("#metric-explanations").append(r);_this.setUpChart(_this.getChartOptions(m))})},setUpShowPractices:function(){$("#showall").on("click",function(e){e.preventDefault();$("#practices li.hidden").each(function(i,item){$(item).removeClass("hidden")});$(this).hide()})},setUpMap:function(orgId,orgType){var _this=this;var map=L.mapbox.map(_this.el.mapPanel,"mapbox.streets").setView([52.905,-1.79],6);map.scrollWheelZoom.disable();var url="/api/1.0/org_location/?org_type="+orgType.toLowerCase();url+="&q="+orgId;var layer=L.mapbox.featureLayer().loadURL(url).on("ready",function(){if(layer.getBounds().isValid()){map.fitBounds(layer.getBounds(),{maxZoom:12});layer.setStyle({fillColor:"#ff00ff",fillOpacity:.2,weight:.5,color:"#333",radius:10})}else{$("#map-container").html("")}}).addTo(map)},setUpChart:function(chartOptions){var _this=this;$.when($.ajax(chartOptions.numOrgUrl),$.ajax(chartOptions.denomOrgUrl),$.ajax(chartOptions.numAllNHS),$.ajax(chartOptions.denomAllNHS)).done(function(numOrgResponse,denomOrgResponse,numAllResponse,denomAllResponse){var numOrgData=numOrgResponse[0];var denomOrgData=denomOrgResponse[0];var combinedOrgData=utils.combineXAndYDatasets(denomOrgData,numOrgData,chartOptions.chartValues);var numAllData=numAllResponse[0];var denomAllData=denomAllResponse[0];var combinedAllData=utils.combineXAndYDatasets(denomAllData,numAllData,chartOptions.chartValues);var chartOrgData=_this.convertData(combinedOrgData);var chartAllData=_this.convertData(combinedAllData);$("#"+this.chartId).find(_this.el.status).hide();_this.renderGraph(chartOptions,chartOrgData,chartAllData)}).fail(function(){$("#"+this.chartId).find(_this.el.status).html(_this.errorMessage).show()})},getChartOptions:function(d){var _this=this;var chartOptions={activeOption:"items",org:_this.orgType,orgIds:[{id:_this.orgId,name:_this.orgName}],num:"chemical"};chartOptions.chartId=d.chartId;chartOptions.numIds=d.numIds;chartOptions.denom=d.denom||"chemical";chartOptions.denomIds=d.denomIds;if(chartOptions.denom!=="chemical"){chartOptions.chartValues={x_val:chartOptions.denom,x:chartOptions.denom}}else{chartOptions.chartValues={x_val:"x_items",x:"items"}}chartOptions.chartValues.y="y_items";chartOptions.chartValues.ratio="ratio_items";var numStr=utils.idsToString(chartOptions.numIds);chartOptions.numOrgUrl=_this.spendUrl+"/?format=json&code="+numStr;chartOptions.numOrgUrl+="&org="+_this.orgId;chartOptions.numAllNHS=_this.baseUrl+"spending/?format=json&code="+numStr;var denomStr=utils.idsToString(chartOptions.denomIds);if(chartOptions.denom==="chemical"){chartOptions.denomOrgUrl=_this.spendUrl+"/?format=json&code="+denomStr;chartOptions.denomAllNHS=_this.baseUrl+"spending/?format=json&code="+denomStr}else{chartOptions.denomOrgUrl=_this.baseUrl+"org_details/?format=json";chartOptions.denomOrgUrl+="&org_type="+_this.orgType.toLowerCase();chartOptions.denomAllNHS=_this.baseUrl+"org_details/?format=json"}chartOptions.denomOrgUrl+="&org="+_this.orgId;chartOptions.friendly=formatters.getFriendlyNamesForChart(chartOptions);return chartOptions},renderGraph:function(chartOptions,combined1,combined2){var _this=this;if(combined1.length){var hcOptions=_this.getHighchartsOptions(chartOptions);hcOptions.series=[{name:"Ratio across "+_this.orgName.replace(/&amp;/g,"&"),data:combined1,color:"red"},{name:"Ratio across all GPs in NHS England",data:combined2}];var chart=new Highcharts.Chart(hcOptions)}else{$("#"+chartOptions.chartId).find(_this.el.status).html("No data found for this "+_this.orgType).show()}},convertData:function(data){_.each(data,function(d){var dates=d.date.split("-");var date=Date.UTC(dates[0],dates[1]-1,dates[2]);d.x=date;d.y=d.ratio_items!==null?parseFloat(d.ratio_items):null});return data},getHighchartsOptions:function(graphOptions){var _this=this,values=graphOptions.chartValues;var options=$.extend(true,{},chartOptions.dashOptions);options.chart.renderTo=graphOptions.chartId;options.yAxis.title.text=graphOptions.friendly.yAxisTitle;options.tooltip={formatter:function(){var str="<b>"+this.series.name;str+=" in "+Highcharts.dateFormat("%b '%y",new Date(this.x));str+="</b><br/>";str+=Highcharts.numberFormat(this.point[values.y],0);str+=graphOptions.denom==="chemical"?" items for ":" ";str+=graphOptions.friendly.friendlyNumerator+"<br/>";str+=Highcharts.numberFormat(this.point[values.x_val],0);str+=graphOptions.denom==="chemical"?" items for ":" ";str+=graphOptions.friendly.friendlyDenominator+"<br/>";str+="Ratio: "+Highcharts.numberFormat(this.point[values.ratio],2);str+=" "+graphOptions.friendly.friendlyNumerator;str+=" items<br/>per "+graphOptions.friendly.fullDenominator;return str}};return options}};dashboard.setUp()})()}).call(this,typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{})},{"./dashboard-measures":1,"./src/chart_formatters":96,"./src/chart_utils":97,"./src/highcharts-options":98,Highcharts:99,bootstrap:4,handlebars:48,jquery:50,"mapbox.js":62,underscore:95}],3:[function(require,module,exports){(function(process,__filename){"use strict";function amdefine(module,requireFn){"use strict";var defineCache={},loaderCache={},alreadyCalled=false,path=require("path"),makeRequire,stringRequire;function trimDots(ary){var i,part;for(i=0;ary[i];i+=1){part=ary[i];if(part==="."){ary.splice(i,1);i-=1}else if(part===".."){if(i===1&&(ary[2]===".."||ary[0]==="..")){break}else if(i>0){ary.splice(i-1,2);i-=2}}}}function normalize(name,baseName){var baseParts;if(name&&name.charAt(0)==="."){if(baseName){baseParts=baseName.split("/");baseParts=baseParts.slice(0,baseParts.length-1);baseParts=baseParts.concat(name.split("/"));trimDots(baseParts);name=baseParts.join("/")}}return name}function makeNormalize(relName){return function(name){return normalize(name,relName)}}function makeLoad(id){function load(value){loaderCache[id]=value}load.fromText=function(id,text){throw new Error("amdefine does not implement load.fromText")};return load}makeRequire=function(systemRequire,exports,module,relId){function amdRequire(deps,callback){if(typeof deps==="string"){return stringRequire(systemRequire,exports,module,deps,relId)}else{deps=deps.map(function(depName){return stringRequire(systemRequire,exports,module,depName,relId)});if(callback){process.nextTick(function(){callback.apply(null,deps)})}}}amdRequire.toUrl=function(filePath){if(filePath.indexOf(".")===0){return normalize(filePath,path.dirname(module.filename))}else{return filePath}};return amdRequire};requireFn=requireFn||function req(){return module.require.apply(module,arguments)};function runFactory(id,deps,factory){var r,e,m,result;if(id){e=loaderCache[id]={};m={id:id,uri:__filename,exports:e};r=makeRequire(requireFn,e,m,id)}else{if(alreadyCalled){throw new Error("amdefine with no module ID cannot be called more than once per file.")}alreadyCalled=true;e=module.exports;m=module;r=makeRequire(requireFn,e,m,module.id)}if(deps){deps=deps.map(function(depName){return r(depName)})}if(typeof factory==="function"){result=factory.apply(m.exports,deps)}else{result=factory}if(result!==undefined){m.exports=result;if(id){loaderCache[id]=m.exports}}}stringRequire=function(systemRequire,exports,module,id,relId){var index=id.indexOf("!"),originalId=id,prefix,plugin;if(index===-1){id=normalize(id,relId);if(id==="require"){return makeRequire(systemRequire,exports,module,relId)}else if(id==="exports"){return exports}else if(id==="module"){return module}else if(loaderCache.hasOwnProperty(id)){return loaderCache[id]}else if(defineCache[id]){runFactory.apply(null,defineCache[id]);return loaderCache[id]}else{if(systemRequire){return systemRequire(originalId)}else{throw new Error("No module with ID: "+id)}}}else{prefix=id.substring(0,index);id=id.substring(index+1,id.length);plugin=stringRequire(systemRequire,exports,module,prefix,relId);if(plugin.normalize){id=plugin.normalize(id,makeNormalize(relId))}else{id=normalize(id,relId)}if(loaderCache[id]){return loaderCache[id]}else{plugin.load(id,makeRequire(systemRequire,exports,module,relId),makeLoad(id),{});return loaderCache[id]}}};function define(id,deps,factory){if(Array.isArray(id)){factory=deps;deps=id;id=undefined}else if(typeof id!=="string"){factory=id;id=deps=undefined}if(deps&&!Array.isArray(deps)){factory=deps;deps=undefined}if(!deps){deps=["require","exports","module"]}if(id){defineCache[id]=[id,deps,factory]}else{runFactory(id,deps,factory)}}define.require=function(id){if(loaderCache[id]){return loaderCache[id]}if(defineCache[id]){runFactory.apply(null,defineCache[id]);return loaderCache[id]}};define.amd={};return define}module.exports=amdefine}).call(this,require("_process"),"/node_modules/amdefine/amdefine.js")},{_process:80,path:79}],4:[function(require,module,exports){require("../../js/transition.js");require("../../js/alert.js");require("../../js/button.js");require("../../js/carousel.js");require("../../js/collapse.js");require("../../js/dropdown.js");require("../../js/modal.js");require("../../js/tooltip.js");require("../../js/popover.js");require("../../js/scrollspy.js");require("../../js/tab.js");require("../../js/affix.js")},{"../../js/affix.js":5,"../../js/alert.js":6,"../../js/button.js":7,"../../js/carousel.js":8,"../../js/collapse.js":9,"../../js/dropdown.js":10,"../../js/modal.js":11,"../../js/popover.js":12,"../../js/scrollspy.js":13,"../../js/tab.js":14,"../../js/tooltip.js":15,"../../js/transition.js":16}],5:[function(require,module,exports){+function($){"use strict";var Affix=function(element,options){this.options=$.extend({},Affix.DEFAULTS,options);this.$target=$(this.options.target).on("scroll.bs.affix.data-api",$.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",$.proxy(this.checkPositionWithEventLoop,this));this.$element=$(element);this.affixed=null;this.unpin=null;this.pinnedOffset=null;this.checkPosition()};Affix.VERSION="3.3.6";Affix.RESET="affix affix-top affix-bottom";Affix.DEFAULTS={offset:0,target:window};Affix.prototype.getState=function(scrollHeight,height,offsetTop,offsetBottom){var scrollTop=this.$target.scrollTop();var position=this.$element.offset();var targetHeight=this.$target.height();if(offsetTop!=null&&this.affixed=="top")return scrollTop<offsetTop?"top":false;if(this.affixed=="bottom"){if(offsetTop!=null)return scrollTop+this.unpin<=position.top?false:"bottom";return scrollTop+targetHeight<=scrollHeight-offsetBottom?false:"bottom"}var initializing=this.affixed==null;var colliderTop=initializing?scrollTop:position.top;var colliderHeight=initializing?targetHeight:height;if(offsetTop!=null&&scrollTop<=offsetTop)return"top";if(offsetBottom!=null&&colliderTop+colliderHeight>=scrollHeight-offsetBottom)return"bottom";return false};Affix.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(Affix.RESET).addClass("affix");var scrollTop=this.$target.scrollTop();var position=this.$element.offset();return this.pinnedOffset=position.top-scrollTop};Affix.prototype.checkPositionWithEventLoop=function(){setTimeout($.proxy(this.checkPosition,this),1)};Affix.prototype.checkPosition=function(){if(!this.$element.is(":visible"))return;var height=this.$element.height();var offset=this.options.offset;var offsetTop=offset.top;var offsetBottom=offset.bottom;var scrollHeight=Math.max($(document).height(),$(document.body).height());if(typeof offset!="object")offsetBottom=offsetTop=offset;if(typeof offsetTop=="function")offsetTop=offset.top(this.$element);if(typeof offsetBottom=="function")offsetBottom=offset.bottom(this.$element);var affix=this.getState(scrollHeight,height,offsetTop,offsetBottom);if(this.affixed!=affix){if(this.unpin!=null)this.$element.css("top","");var affixType="affix"+(affix?"-"+affix:"");var e=$.Event(affixType+".bs.affix");this.$element.trigger(e);if(e.isDefaultPrevented())return;this.affixed=affix;this.unpin=affix=="bottom"?this.getPinnedOffset():null;this.$element.removeClass(Affix.RESET).addClass(affixType).trigger(affixType.replace("affix","affixed")+".bs.affix")}if(affix=="bottom"){this.$element.offset({top:scrollHeight-height-offsetBottom})}};function Plugin(option){return this.each(function(){var $this=$(this);var data=$this.data("bs.affix");var options=typeof option=="object"&&option;if(!data)$this.data("bs.affix",data=new Affix(this,options));if(typeof option=="string")data[option]()})}var old=$.fn.affix;$.fn.affix=Plugin;$.fn.affix.Constructor=Affix;$.fn.affix.noConflict=function(){$.fn.affix=old;return this};$(window).on("load",function(){$('[data-spy="affix"]').each(function(){var $spy=$(this);var data=$spy.data();data.offset=data.offset||{};if(data.offsetBottom!=null)data.offset.bottom=data.offsetBottom;if(data.offsetTop!=null)data.offset.top=data.offsetTop;Plugin.call($spy,data)})})}(jQuery)},{}],6:[function(require,module,exports){+function($){"use strict";var dismiss='[data-dismiss="alert"]';var Alert=function(el){$(el).on("click",dismiss,this.close)};Alert.VERSION="3.3.6";Alert.TRANSITION_DURATION=150;Alert.prototype.close=function(e){var $this=$(this);var selector=$this.attr("data-target");if(!selector){selector=$this.attr("href");selector=selector&&selector.replace(/.*(?=#[^\s]*$)/,"")}var $parent=$(selector);if(e)e.preventDefault();if(!$parent.length){$parent=$this.closest(".alert")}$parent.trigger(e=$.Event("close.bs.alert"));if(e.isDefaultPrevented())return;$parent.removeClass("in");function removeElement(){$parent.detach().trigger("closed.bs.alert").remove()}$.support.transition&&$parent.hasClass("fade")?$parent.one("bsTransitionEnd",removeElement).emulateTransitionEnd(Alert.TRANSITION_DURATION):removeElement()};function Plugin(option){return this.each(function(){var $this=$(this);var data=$this.data("bs.alert");if(!data)$this.data("bs.alert",data=new Alert(this));if(typeof option=="string")data[option].call($this)})}var old=$.fn.alert;$.fn.alert=Plugin;$.fn.alert.Constructor=Alert;$.fn.alert.noConflict=function(){$.fn.alert=old;return this};$(document).on("click.bs.alert.data-api",dismiss,Alert.prototype.close)}(jQuery)},{}],7:[function(require,module,exports){+function($){"use strict";var Button=function(element,options){this.$element=$(element);this.options=$.extend({},Button.DEFAULTS,options);this.isLoading=false};Button.VERSION="3.3.6";Button.DEFAULTS={loadingText:"loading..."};Button.prototype.setState=function(state){var d="disabled";var $el=this.$element;var val=$el.is("input")?"val":"html";var data=$el.data();state+="Text";if(data.resetText==null)$el.data("resetText",$el[val]());setTimeout($.proxy(function(){$el[val](data[state]==null?this.options[state]:data[state]);if(state=="loadingText"){this.isLoading=true;$el.addClass(d).attr(d,d)}else if(this.isLoading){this.isLoading=false;$el.removeClass(d).removeAttr(d)}},this),0)};Button.prototype.toggle=function(){var changed=true;var $parent=this.$element.closest('[data-toggle="buttons"]');if($parent.length){var $input=this.$element.find("input");if($input.prop("type")=="radio"){if($input.prop("checked"))changed=false;$parent.find(".active").removeClass("active");this.$element.addClass("active")}else if($input.prop("type")=="checkbox"){if($input.prop("checked")!==this.$element.hasClass("active"))changed=false;this.$element.toggleClass("active")}$input.prop("checked",this.$element.hasClass("active"));if(changed)$input.trigger("change")}else{this.$element.attr("aria-pressed",!this.$element.hasClass("active"));this.$element.toggleClass("active")}};function Plugin(option){return this.each(function(){var $this=$(this);var data=$this.data("bs.button");var options=typeof option=="object"&&option;if(!data)$this.data("bs.button",data=new Button(this,options));if(option=="toggle")data.toggle();else if(option)data.setState(option)})}var old=$.fn.button;$.fn.button=Plugin;$.fn.button.Constructor=Button;$.fn.button.noConflict=function(){$.fn.button=old;return this};$(document).on("click.bs.button.data-api",'[data-toggle^="button"]',function(e){var $btn=$(e.target);if(!$btn.hasClass("btn"))$btn=$btn.closest(".btn");Plugin.call($btn,"toggle");if(!($(e.target).is('input[type="radio"]')||$(e.target).is('input[type="checkbox"]')))e.preventDefault()}).on("focus.bs.button.data-api blur.bs.button.data-api",'[data-toggle^="button"]',function(e){$(e.target).closest(".btn").toggleClass("focus",/^focus(in)?$/.test(e.type))})}(jQuery)},{}],8:[function(require,module,exports){+function($){"use strict";var Carousel=function(element,options){this.$element=$(element);this.$indicators=this.$element.find(".carousel-indicators");this.options=options;this.paused=null;this.sliding=null;this.interval=null;this.$active=null;this.$items=null;this.options.keyboard&&this.$element.on("keydown.bs.carousel",$.proxy(this.keydown,this));this.options.pause=="hover"&&!("ontouchstart"in document.documentElement)&&this.$element.on("mouseenter.bs.carousel",$.proxy(this.pause,this)).on("mouseleave.bs.carousel",$.proxy(this.cycle,this))};Carousel.VERSION="3.3.6";Carousel.TRANSITION_DURATION=600;Carousel.DEFAULTS={interval:5e3,pause:"hover",wrap:true,keyboard:true};Carousel.prototype.keydown=function(e){if(/input|textarea/i.test(e.target.tagName))return;switch(e.which){case 37:this.prev();break;case 39:this.next();break;default:return}e.preventDefault()};Carousel.prototype.cycle=function(e){e||(this.paused=false);this.interval&&clearInterval(this.interval);this.options.interval&&!this.paused&&(this.interval=setInterval($.proxy(this.next,this),this.options.interval));return this};Carousel.prototype.getItemIndex=function(item){this.$items=item.parent().children(".item");return this.$items.index(item||this.$active)};Carousel.prototype.getItemForDirection=function(direction,active){var activeIndex=this.getItemIndex(active);var willWrap=direction=="prev"&&activeIndex===0||direction=="next"&&activeIndex==this.$items.length-1;if(willWrap&&!this.options.wrap)return active;var delta=direction=="prev"?-1:1;var itemIndex=(activeIndex+delta)%this.$items.length;return this.$items.eq(itemIndex)};Carousel.prototype.to=function(pos){var that=this;var activeIndex=this.getItemIndex(this.$active=this.$element.find(".item.active"));if(pos>this.$items.length-1||pos<0)return;if(this.sliding)return this.$element.one("slid.bs.carousel",function(){that.to(pos)});if(activeIndex==pos)return this.pause().cycle();return this.slide(pos>activeIndex?"next":"prev",this.$items.eq(pos))};Carousel.prototype.pause=function(e){e||(this.paused=true);if(this.$element.find(".next, .prev").length&&$.support.transition){this.$element.trigger($.support.transition.end);this.cycle(true)}this.interval=clearInterval(this.interval);return this};Carousel.prototype.next=function(){if(this.sliding)return;return this.slide("next")};Carousel.prototype.prev=function(){if(this.sliding)return;return this.slide("prev")};Carousel.prototype.slide=function(type,next){var $active=this.$element.find(".item.active");var $next=next||this.getItemForDirection(type,$active);var isCycling=this.interval;var direction=type=="next"?"left":"right";var that=this;if($next.hasClass("active"))return this.sliding=false;var relatedTarget=$next[0];var slideEvent=$.Event("slide.bs.carousel",{relatedTarget:relatedTarget,direction:direction});this.$element.trigger(slideEvent);if(slideEvent.isDefaultPrevented())return;this.sliding=true;isCycling&&this.pause();if(this.$indicators.length){this.$indicators.find(".active").removeClass("active");var $nextIndicator=$(this.$indicators.children()[this.getItemIndex($next)]);$nextIndicator&&$nextIndicator.addClass("active")}var slidEvent=$.Event("slid.bs.carousel",{relatedTarget:relatedTarget,direction:direction});if($.support.transition&&this.$element.hasClass("slide")){$next.addClass(type);$next[0].offsetWidth;$active.addClass(direction);$next.addClass(direction);$active.one("bsTransitionEnd",function(){$next.removeClass([type,direction].join(" ")).addClass("active");$active.removeClass(["active",direction].join(" "));that.sliding=false;setTimeout(function(){that.$element.trigger(slidEvent)},0)}).emulateTransitionEnd(Carousel.TRANSITION_DURATION)}else{$active.removeClass("active");$next.addClass("active");this.sliding=false;this.$element.trigger(slidEvent)}isCycling&&this.cycle();return this};function Plugin(option){return this.each(function(){var $this=$(this);var data=$this.data("bs.carousel");var options=$.extend({},Carousel.DEFAULTS,$this.data(),typeof option=="object"&&option);var action=typeof option=="string"?option:options.slide;if(!data)$this.data("bs.carousel",data=new Carousel(this,options));if(typeof option=="number")data.to(option);else if(action)data[action]();else if(options.interval)data.pause().cycle()})}var old=$.fn.carousel;$.fn.carousel=Plugin;$.fn.carousel.Constructor=Carousel;$.fn.carousel.noConflict=function(){$.fn.carousel=old;return this};var clickHandler=function(e){var href;var $this=$(this);var $target=$($this.attr("data-target")||(href=$this.attr("href"))&&href.replace(/.*(?=#[^\s]+$)/,""));if(!$target.hasClass("carousel"))return;var options=$.extend({},$target.data(),$this.data());var slideIndex=$this.attr("data-slide-to");if(slideIndex)options.interval=false;Plugin.call($target,options);if(slideIndex){$target.data("bs.carousel").to(slideIndex)}e.preventDefault()};$(document).on("click.bs.carousel.data-api","[data-slide]",clickHandler).on("click.bs.carousel.data-api","[data-slide-to]",clickHandler);$(window).on("load",function(){$('[data-ride="carousel"]').each(function(){var $carousel=$(this);Plugin.call($carousel,$carousel.data())})})}(jQuery)},{}],9:[function(require,module,exports){+function($){"use strict";var Collapse=function(element,options){this.$element=$(element);this.options=$.extend({},Collapse.DEFAULTS,options);this.$trigger=$('[data-toggle="collapse"][href="#'+element.id+'"],'+'[data-toggle="collapse"][data-target="#'+element.id+'"]');this.transitioning=null;if(this.options.parent){this.$parent=this.getParent()}else{this.addAriaAndCollapsedClass(this.$element,this.$trigger)}if(this.options.toggle)this.toggle()};Collapse.VERSION="3.3.6";Collapse.TRANSITION_DURATION=350;Collapse.DEFAULTS={toggle:true};Collapse.prototype.dimension=function(){var hasWidth=this.$element.hasClass("width");return hasWidth?"width":"height"};Collapse.prototype.show=function(){if(this.transitioning||this.$element.hasClass("in"))return;var activesData;var actives=this.$parent&&this.$parent.children(".panel").children(".in, .collapsing");if(actives&&actives.length){activesData=actives.data("bs.collapse");if(activesData&&activesData.transitioning)return}var startEvent=$.Event("show.bs.collapse");this.$element.trigger(startEvent);if(startEvent.isDefaultPrevented())return;if(actives&&actives.length){Plugin.call(actives,"hide");activesData||actives.data("bs.collapse",null)}var dimension=this.dimension();this.$element.removeClass("collapse").addClass("collapsing")[dimension](0).attr("aria-expanded",true);this.$trigger.removeClass("collapsed").attr("aria-expanded",true);this.transitioning=1;var complete=function(){this.$element.removeClass("collapsing").addClass("collapse in")[dimension]("");this.transitioning=0;this.$element.trigger("shown.bs.collapse")};if(!$.support.transition)return complete.call(this);var scrollSize=$.camelCase(["scroll",dimension].join("-"));this.$element.one("bsTransitionEnd",$.proxy(complete,this)).emulateTransitionEnd(Collapse.TRANSITION_DURATION)[dimension](this.$element[0][scrollSize])};Collapse.prototype.hide=function(){if(this.transitioning||!this.$element.hasClass("in"))return;var startEvent=$.Event("hide.bs.collapse");this.$element.trigger(startEvent);if(startEvent.isDefaultPrevented())return;var dimension=this.dimension();this.$element[dimension](this.$element[dimension]())[0].offsetHeight;this.$element.addClass("collapsing").removeClass("collapse in").attr("aria-expanded",false);this.$trigger.addClass("collapsed").attr("aria-expanded",false);this.transitioning=1;var complete=function(){this.transitioning=0;this.$element.removeClass("collapsing").addClass("collapse").trigger("hidden.bs.collapse")};if(!$.support.transition)return complete.call(this);this.$element[dimension](0).one("bsTransitionEnd",$.proxy(complete,this)).emulateTransitionEnd(Collapse.TRANSITION_DURATION)};Collapse.prototype.toggle=function(){this[this.$element.hasClass("in")?"hide":"show"]()};Collapse.prototype.getParent=function(){return $(this.options.parent).find('[data-toggle="collapse"][data-parent="'+this.options.parent+'"]').each($.proxy(function(i,element){
