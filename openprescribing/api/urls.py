...
urlpatterns = [
    ...
    url(r'^tariff/$', views_spending.tariff,
        name='tariff_api'),
    url(r'^spending_by_ccg/$', views_spending.spending_by_org,
        name='spending_by_ccg', kwargs={'org_type': 'ccg'}),
    url(r'^spending_by_practice/$', views_spending.spending_by_org,
        name='spending_by_practice', kwargs={'org_type': 'practice'}),
    url(r'^spending_by_org/$', views_spending.spending_by_org,
        name='spending_by_org'),
    url(r'^measure/$', views_measures.measure_global,
        name='measure'),
    url(r'^measure_by_stp/$', views_measures.measure_by_stp,
        name='measure_by_stp'),
    url(r'^measure_by_regional_team/$', views_measures.measure_by_regional_team,
