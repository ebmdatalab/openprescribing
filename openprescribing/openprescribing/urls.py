...
urlpatterns = [
    ...
    url(r'^chemical/(?P<bnf_code>[A-Z\d]+)/$',
        frontend_views.chemical,
        name='chemical'),
    ...
    url(r'^ccg/(?P<ccg_code>[A-Z\d]+)/measures/$',
        RedirectView.as_view(
            permanent=True, pattern_name='measures_for_one_ccg'),
        name='ccg'),
    ...
    url(r'^bnf/(?P<section_id>[\d]+)/$',
        frontend_views.bnf_section,
        name='bnf_section'),
    ...
    url(r'^last_bookmark/$',
        ...
        name='last-bookmark'),
    url(r'^analyse/preview/$',
        bookmark_views.preview_analysis_bookmark,
