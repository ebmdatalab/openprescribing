...
urlpatterns = [
    ...
    url(r'^practice/(?P<entity_code>[A-Z\d]+)/concessions/$',
        ...
        kwargs={'entity_type': 'practice'}),
    url(r'^pcn/(?P<entity_code>[A-Z\d]+)/concessions/$',
        frontend_views.spending_for_one_entity,
    ...
    url(r'^ccg/(?P<entity_code>[A-Z\d]+)/concessions/$',
        ...
        kwargs={'entity_type': 'CCG'}),
    url(r'^stp/(?P<entity_code>[A-Z\d]+)/concessions/$',
        frontend_views.spending_for_one_entity,
        name='spending_for_one_stp',
        kwargs={'entity_type': 'stp'}),
    url(r'^regional-team/(?P<entity_code>[A-Z\d]+)/concessions/$',
        frontend_views.spending_for_one_entity,
    ...
    url(r'^measure/(?P<measure>[A-Za-z\d_]+)/'
        ...
        kwargs={'entity_type': 'practice'}),
    url(r'^measure/(?P<measure>[A-Za-z\d_]+)/pcn/(?P<entity_code>[A-Z\d]+)/$',
        frontend_views.measure_for_one_entity,
    ...
    url(r'^pcn/(?P<pcn_code>[A-Z\d]+)/measures/$',
    ...
    url(r'^pcn/(?P<pcn_code>[A-Z\d]+)/(?P<measure>[A-Za-z\d_]+)/$',
    ...
    url(r'^measure/(?P<measure>[A-Za-z\d_]+)/$',
        ...
        kwargs={'entity_type': 'ccg'}),
    url(r'^measure/(?P<measure>[A-Za-z\d_]+)/pcn/$',
        frontend_views.measure_for_all_entities,
